...
> _Crafting Code with Passion and Purpose_

I'm a 17 y/o dev from India who finds joy in making cool stuff — whether it's bots, tools for accessibility, or baking cookies while debugging 🧁  
...
- 🧙‍♂️ Running **Arch Linux**
  ‣ Fully **encrypted with LUKS**, running on **Btrfs**, because safety _and_ snapshots hit different  
  ‣ Rocking **Hyprland** for that clean, minimal yet chaotic WM life
- 💾 I break Windows just to fix it better (been over half an year since I switched to arch, not going back anytime soon)
- 👑 I vibe with Python, Bash (honestly zsh better), PySide6, terminal themes & performance tweaks
...
| **Chrona**    | Converts Word docs, text files and pdfs to speech for visually impaired students | Python, pyttsx3, python-docx... |
